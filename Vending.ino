...
const char* ssid = "jjodelle";
const char* password = "chimichangga";

/* ================= SERVER API ================= */

const char* rfidURL = "http://172.20.10.13:5001/api/check-rfid?uid=";
const char* purchaseURL = "http://172.20.10.13:5001/api/purchase";
const char* restockURL = "http://172.20.10.13:5001/api/restock";
const char* productInfoURL = "http://172.20.10.13:5001/api/product-info?product=";
